...
import { validatePatternWithSpecificName } from "../../service/login";
...
export function Login() {
  ...
  function handleLogin(values: Form) {
    if (validatePatternWithSpecificName(values.password, values.name)) {
      setName(values.name);
      return navigate("/images");
    }
    return setError("root", {
      message: "Ha ocurrido un error al validar tus credenciales.",
    });
  }
